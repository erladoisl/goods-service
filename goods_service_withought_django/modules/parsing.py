...
try:
    ...
    from modules.market.dns import parse as dns_parse
    from modules.market.eldorado import parse as eldorado_parse
...
def get_price(link):
    ''' 
        ...
        >>> price = get_price('https://market.yandex.ru/product--vstraivaemaia-posudomoechnaia-mashina-weissgauff-bdw-4533-d/775151031?cpc=pu2SzFuggs0dqoPGEw-6zsZGDsucLOCDvMAiSiBlSLXSOAzuLCEDKV3Mz3MqbeHDVBdLbVCgmiDObhmUkkCtJwQVt5MqWWpwAJ6YLo2FXSJrVqmqeq6R1DDQqLhqlhfQaA-KP6DNCOOd5YOL3jo21z0Mgqo2_8gaFlOQH1IKZVcULTMbscRoTFGeoLmWXoLA&sku=775151031&offerid=QOvDc9gJ95NH_3rrb9OYvg&cpa=1')
        >>> price
        39990
        >>> price = get_price('https://www.dns-shop.ru/product/82fca53498c53332/vstraivaemaa-posudomoecnaa-masina-electrolux-edm43210l/')
        >>> price
        50799
